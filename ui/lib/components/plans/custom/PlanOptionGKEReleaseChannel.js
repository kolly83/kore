...
const releaseChannels = [
  { value: 'UNSPECIFIED', display: 'None (not recommended)' },
...
const releaseChannelInfo = {
  'UNSPECIFIED': 'No release channel set - specify version below or choose a channel (recommended)',
  ...
  render() {
    ...
    const help = (
      <>
        ...
        {valueOrDefault === 'UNSPECIFIED' ? null : <Paragraph type="secondary">All channels receive critical security patches as required.</Paragraph>}
      </>
    )
